<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appointmentform.aspx.cs" Inherits="online_food_donation_project.appointmentform" %>
			      		...
			      		<div class="col-sm-6 col-md-6 donation-form-samount">
			      			...
			      			<ul class="list-inline selected-amount">
			      				<li class="amount-box">
                                    ...
                                    <asp:RadioButton ID="RadioButton4" type="radio" name="payment-group"> --%> runat="server" />
			      					<label for="radio-one"> $10</label>
			      				</li>
			      				<li class="amount-box">
				      				<%--<input id="radio-two" type="radio" name="payment-group"> --%>
                                    <asp:RadioButton ID="RadioButton2" type="radio" name="payment-group"> --%> runat="server" />
			      					<label for="radio-two"> $20</label>
			      				</li>
			      				<li class="amount-box">
				      				<%--<input id="radio-three" type="radio" name="payment-group"> --%>
                                    <asp:RadioButton ID="RadioButton3" type="radio" name="payment-group"> --%> runat="server" />
			      					<label for="radio-three"> $30</label>
			      				</li>
			      				<li class="amount-box">
<%--				      				<input id="radio-four" type="radio" name="payment-group"> --%>
                                    <asp:RadioButton ID="RadioButton1" type="radio" name="payment-group"> --%> runat="server" />
			      					<label for="radio-four"> $50</label>
			      				</li>
			      				<li class="amount-box">
				      			<%--	<input id="radio-five" type="radio" name="payment-group">--%>
									<asp:RadioButton ID="RadioButton5" type="radio" name="payment-group"> runat="server" />
			      			...
			      			<div class="form-inline">
							    ...
							    <div class="form-group">
								    ...
								    <div class="input-group">
                                        ...
                                        <asp:TextBox ID="TextBox1" class="form-control" placeholder="Amount" runat="server"></asp:TextBox>
			      		...
			      		<div class="col-sm-12 col-md-12">
					        <div class="donation-form donor-details>
				        			...
				        			<div class="col-md-6">
    						            <div class="form-group">
        								   <%-- <input type="email" class="form-control required" id="exampleInputEmailxy" placeholder="Email"> --%>
                                            <asp:TextBox ID="TextBox4" class="form-control required" placeholder="Email" runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        			<div class="col-md-6">
    						            <div class="form-group">
        								    <%--<input type="text" class="form-control required" id="exampleInputPhone" placeholder="Phone"> --%>
                                            <asp:TextBox ID="TextBox5" class="form-control required" placeholder="Phone" runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        			<div class="col-md-6">
    						            <div class="form-group">
        								   <%-- <input type="text" class="form-control required" id="exampleInputAddress" placeholder="Address line 1"> --%>
                                            <asp:TextBox ID="TextBox7" class="form-control required" placeholder="Address line 1" runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        			<div class="col-md-6">
    						            <div class="form-group">
        								    <%--<input type="text" class="form-control required" id="exampleInputAddress2" placeholder="Address line 2"> --%>
                                            <asp:TextBox ID="TextBox8" class="form-control required" placeholder="Address line 2" runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        			<div class="col-md-6">
    						            <div class="form-group">
        								   <%-- <input type="text" class="form-control required" id="exampleInputCity" placeholder="City/State"> --%>
                                            <asp:TextBox ID="TextBox9" class="form-control required" placeholder="City/State" runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        			<div class="col-md-6">
	       						            <div class="form-group">
        								   <%-- <input type="text" class="form-control required" id="exampleInputZip" placeholder="Zipcode/Postcode"> --%>
                                            <asp:TextBox ID="TextBox6" class="form-control required" placeholder="Zipcode/Postcode" runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        		</div>
	 	                            <div class="form-group">
								...
								<div class="form-group text-center">
                                    ...
                                    <asp:Button ID="Button1" class="btn btn-lg btn-block ulockd-btn-thm2" runat="server" Text="Donate now" />
								</div>
					        </div>
			      		</div>
			      	</div>
  			...
  			<div class="row">
  				<div class="col-xs-12 col-sm-6 col-lg-3 col-lg-3">
  					<div class="ulockd-welcm-hmddl">
						<a href="index.aspx" class="ulockd-main-logo"><img src="images/header-logo.png" alt=""></a>
  					</div>
  				</div>
  				<div class="col-xs-12 col-sm-6 col-lg-3 col-lg-3">
			        ...
			        <div class="container ulockd-pdng0">
			            ...
			            <div class="navbar-header">
			               <%-- <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-menu"> --%>
						    <asp:Button ID="Button6" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-menu" runat="server" Text="Button" />
			            ...
			            <div class="collapse navbar-collapse ulockd-padd-md-30" id="navbar-menu">
			                <ul class="nav navbar-nav navbar-left">
			                    <li class="dropdown">
			                        ...
			                        <ul class="dropdown-menu">
										<li class="dropdown">
					                        ...
					                        <ul class="dropdown-menu">
												<li><a href="index-multipage.aspx">Multipage One</a></li>
												<li><a href="index-multipage2.aspx">Multipage Two</a></li>
					                        </ul>
					                    </li>
										<li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Single Page</a>
					                        <ul class="dropdown-menu">
												<li><a href="index-singlepage.aspx">Single Page One</a></li>
												<li><a href="index-singlepage2.aspx">Single Page Two</a></li>
					                        </ul>
					                    </li>
										<li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Boxed Style</a>
					                        <ul class="dropdown-menu">
												<li><a href="index-multipage-boxed.aspx">Multipage One Boxed</a></li>
												<li><a href="index-multipage2-boxed.aspx">Multipage Two Boxed</a></li>
												<li><a href="index-singlepage-boxed.aspx">Single Page One Boxed</a></li>
												<li><a href="index-singlepage2-boxed.aspx">Single Page Two Boxed</a></li>
					                        </ul>
					                    </li>
										<li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">RTL Style</a>
					                        <ul class="dropdown-menu">
												<li><a href="index-multipage-rtl.aspx">Multipage One RTL</a></li>
												<li><a href="index-multipage2-rtl.aspx">Multipage Two RTL</a></li>
												<li><a href="index-singlepage-rtl.aspx">Single Page One RTL</a></li>
												<li><a href="index-singlepage2-rtl.aspx">Single Page Two RTL</a></li>
					                        </ul>
					                    </li>
			                        </ul>
			                    </li>
			                        ...
			                        <ul class="dropdown-menu">
					                    <li class="dropdown">
					                        ...
					                        <ul class="dropdown-menu">
												...
												<li><a href="page-about2.aspx">About Two</a></li>
												<li><a href="page-about3.aspx">About Three</a></li>
					                        </ul>
					                    </li>
					                    <li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Causes</a>
					                        <ul class="dropdown-menu">
												<li><a href="page-causes-grid.aspx">Causes Grid</a></li>
												<li><a href="page-causes-list.aspx">Causes List</a></li>
												<li><a href="page-causes-single.aspx">Causes Single</a></li>
					                        </ul>
					                    </li>
					                    <li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Volunteer</a>
					                        <ul class="dropdown-menu">
												<li><a href="page-team-one.aspx">Volunteer One</a></li>
												<li><a href="page-team-two.aspx">Volunteer Two</a></li>
												<li><a href="page-team-details.aspx">Volunteer Details</a></li>
												<li><a href="page-team-registration.aspx">Volunteer Registration</a></li>
					                        </ul>
					                    </li>
					                    <li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Booking Form</a>
					                        <ul class="dropdown-menu">
												<li><a href="ulockd-booking-form.aspx">Form One</a></li>
												<li><a href="ulockd-booking-form2.aspx">Form Two</a></li>
												<li><a href="ulockd-booking-form3.aspx">Form Three</a></li>
					                        </ul>
					                    </li>
					                    <li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Job Apply Form</a>
					                        <ul class="dropdown-menu">
												<li><a href="ulockd-job-apply-form.aspx">Form One</a></li>
												<li><a href="ulockd-job-apply-form2.aspx">Form Two</a></li>
					                        </ul>
					                    </li>
			                        </ul>
			                    </li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
										<li class="dropdown">
											<a href="blog-grid-one.aspx" class="dropdown-toggle" data-toggle="dropdown">Blog Grid</a>
	                                        <ul class="dropdown-menu">
												<li><a href="blog-grid-one.aspx">Blog Grid One</a></li>
												<li><a href="blog-grid-two.aspx">Blog Grid Two</a></li>
												<li><a href="blog-grid-three.aspx">Blog Grid Three</a></li>
	                                        </ul>
										</li>
										<li class="dropdown">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog Single</a>
	                                        <ul class="dropdown-menu">
												<li><a href="blog-signle-left-sidebar.aspx">Sidebar left</a></li>
												<li><a href="blog-signle-right-sidebar.aspx">Sidebar Right</a></li>
												<li><a href="blog-signle-sidebar-less.aspx">Sidebar Less</a></li>
	                                        </ul>
										</li>
										<li class="dropdown">
											<a href="#" class="dropdown-toggle" data-toggle="dropdown">Blog Classic</a>
	                                        <ul class="dropdown-menu">
												<li><a href="blog-left-sidebar.aspx">Sidebar left</a></li>
												<li><a href="blog-right-sidebar.aspx">Sidebar Right</a></li>
												<li><a href="blog-sidebar-less.aspx">Sidebar Less</a></li>
	                                        </ul>
										</li>
                                    </ul>
                                </li>
			                    <li class="dropdown">
			                        ...
			                        <ul class="dropdown-menu">
										<li><a href="page-appointment.aspx">Appointment</a></li>
										<li><a href="page-coming-soon.aspx">Coming Soon</a></li>
										<li><a href="page-donation.aspx">Donation Form</a></li>
										<li><a href="page-error.aspx">Error</a></li>
					                    <li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Event</a>
					                        <ul class="dropdown-menu">
												<li><a href="page-event-grid.aspx">Event Grid</a></li>
												<li><a href="page-event-list.aspx">Event List</a></li>
												<li><a href="page-event-single.aspx">Event Single</a></li>
					                        </ul>
					                    </li>
					                    ...
					                    <li class="dropdown">
					                        ...
					                        <ul class="dropdown-menu">
												<li><a href="page-fullcalendar.aspx">Monthly Event</a></li>
												<li><a href="page-fullcalendar2.aspx">Weekly Event</a></li>
					                        </ul>
					                    </li>
					                    <li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Gallery</a>
					                        <ul class="dropdown-menu">
												<li><a href="page-gallery.aspx">Gallery One</a></li>
												<li><a href="page-gallery2.aspx">Gallery Two</a></li>
												<li><a href="page-gallery3.aspx">Gallery Three</a></li>
					                        </ul>
					                    </li>
					                    <li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pricing</a>
					                        <ul class="dropdown-menu">
												<li><a href="page-pricing.aspx">Pricing One</a></li>
												<li><a href="page-pricing2.aspx">Pricing Two</a></li>
					                        </ul>
					                    </li>
					                    <li class="dropdown">
					                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Shop</a>
					                        <ul class="dropdown-menu">
												<li><a href="page-shop.aspx">Our Shop</a></li>
												<li><a href="page-product-details.aspx">Product Details</a></li>
												<li><a href="page-shoping-cart.aspx">Shopping Cart</a></li>
												<li><a href="page-shoping-checkout.aspx">Shopping Checkout</a></li>
					                        </ul>
					                    </li>
			                    ...
			                    <li class="dropdown">
			                        ...
			                        <ul class="dropdown-menu">
										...
										<li><a href="page-contact2.aspx">Contact Us Two</a></li>
			                        </ul>
			                    </li>
			                </ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-md-7">
                    ...
                    <div id="appointment_form" name="appointment_form" class="appointment_form text-center">
                        ...
                        <div class="row">
                            ...
                            <%--        <input id="form_name" name="form_name" class="form-control" placeholder="enter a name" required="required" data-error="Name is required." type="text">--%> 
                                    <asp:TextBox ID="TextBox11" class="form-control" placeholder="enter a name" required="required" data-error="Name is required." type="text" runat="server"></asp:TextBox>
...
<%--                                    <input id="form_email" name="form_email" class="form-control required email" placeholder="enter an email" required="required" data-error="Email is required." type="email"> --%>
                                    <asp:TextBox ID="TextBox12" class="form-control required email" placeholder="enter an email" required="required" data-error="Email is required." type="email" runat="server"></asp:TextBox>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
...
<%--                                    <input id="form_date" name="form_date" class="form-control required datepicker" placeholder="enter a date" required="required" data-error="Subject is required." type="text"> --%>
                                    <asp:TextBox ID="TextBox13" class="form-control required datepicker" placeholder="enter a date" required="required" data-error="Subject is required." type="text" runat="server"></asp:TextBox>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div> 
                            <div class="col-md-6">
                           ...
                           <%--         <input id="form_phone" name="form_phone" class="form-control required" placeholder="enter a phone" required="required" data-error="Phone Number is required." type="text">--%> 
                                    <asp:TextBox ID="TextBox14" class="form-control required" placeholder="enter a phone" required="required" data-error="Phone Number is required." type="text" runat="server"></asp:TextBox>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>  
                        </div>
    ...
    $(function () {
        ...
        $('#appointment_form').on('submit', function (e) {
            if (!e.isDefaultPrevented()) {
                var url = "includes/appointment.html";
                $.ajax({
                    type: "POST",
                    url: url,
                    data: $(this).serialize(),
...
<!-- Mirrored from unlockdesizn.com/html/non-profit/be-ahand/demo/page-appointment.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Jun 2021 12:59:40 GMT -->
</html>