<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="booking-form.aspx.cs" Inherits="online_food_donation_project.booking_form" %>
		...
		<div class="container text-center">
			<div class="row">
				<div class="ulockd-inner-conraimer-details">
					<div class="col-md-12">
						<h1 class="text-uppercase">BOOKIG FORM</h1>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-sm-12 col-md-6 col-md-offset-3">
					<div class="booking_form_style1 text-center">
		                <!-- Booking Form Sart-->
			            <div id="booking_form" class="booking_form text-center">
							...
							<div class="row">
				                ...
				                <div class="col-sm-12">
				                    <div class="form-group">										
										<asp:TextBox ID="TextBox1" class="form-control form_control" placeholder="Full Name" runat="server"></asp:TextBox>
				                ...
				                <div class="col-sm-12">
				                    <div class="form-group">				                    	
										<asp:TextBox ID="TextBox2" TextMode="Email" class="form-control form_control required email" placeholder="Email" runat="server"></asp:TextBox>
				                ...
				                <div class="col-sm-6">
				                    <div class="form-group">					                    
										<asp:TextBox ID="TextBox3" TextMode="Phone" class="form-control form_control required" placeholder="Phone Number" runat="server"></asp:TextBox>
				                ...
				                <div class="col-sm-6">
				                    <div class="form-group">
					                    <div class="ulockd-select-style">											
											<asp:DropDownList ID="DropDownList1" class="form-control form_control required booking_form_control" runat="server">
												<asp:ListItem Value="Food Donation Campaign">Food Donation Campaign</asp:ListItem>  
												<asp:ListItem Value="Fighting Hunger">Fighting Hunger</asp:ListItem>  
												<asp:ListItem Value="Poster Design Competition">Poster Design Competition</asp:ListItem>  
												<asp:ListItem Value="Food Marathon">Food Marathon</asp:ListItem>  										 
											</asp:DropDownList>
					                    </div>
										<div class="help-block with-errors"></div>
				                    </div>
				                ...
				                <div class="col-sm-12">									
		                            <div class="form-group">
		                                <asp:TextBox ID="TextBox4" TextMode="MultiLine" class="form-control ulockd-form-tb required" rows="5" placeholder="Your Massage / Note" runat="server"></asp:TextBox>										
		                                <div class="help-block with-errors"></div>
		                            </div>
				                    <div class="form-group">
										<asp:Button ID="Button1" class="btn btn-lg ulockd-btn-thm2 btn-block" runat="server" Text="Book Your Seat Now" OnClick="book_Click" />					                   
				                    </div>
...
<script type="text/javascript" src="js/form-script.html"></script>
