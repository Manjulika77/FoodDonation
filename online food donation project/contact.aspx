<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="online_food_donation_project.contact" %>
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="ulockd-contact-form">
                        <div id="contact_form" name="contact_form" class="contact-form">
                            <div class="messages"></div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">                                        
										<asp:TextBox ID="TextBox1" class="form-control ulockd-form-fg required" placeholder="Your name" runat="server"></asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">                                        
										<asp:TextBox ID="TextBox2" class="form-control ulockd-form-fg required" TextMode="Email" placeholder="Your email" runat="server"></asp:TextBox>
	                            ...
	                            <div class="col-md-3">
	                                <div class="form-group">	                                    
	                                    <asp:TextBox ID="TextBox3" class="form-control ulockd-form-fg required" TextMode="Phone" placeholder="Your Phone" runat="server"></asp:TextBox>
										<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3" ErrorMessage="Phone is required!" ForeColor="Red"></asp:RequiredFieldValidator>
										<div class="help-block with-errors"></div>
	                                </div>
	                            </div>
	                            <div class="col-md-3">
	                                <div class="form-group">
										<asp:TextBox ID="TextBox4" class="form-control ulockd-form-fg required" placeholder="Subject" runat="server"></asp:TextBox>
										<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox4" ErrorMessage="Subject is required!" ForeColor="Red"></asp:RequiredFieldValidator>	                                    
	                                    <div class="help-block with-errors"></div>
	                                </div>
	                            </div>
                                <div class="col-md-12">
		                            <div class="form-group">
										<asp:TextBox ID="TextBox5" class="form-control ulockd-form-fg required" TextMode="MultiLine" placeholder="Your massage" rows="12" style="height: 224px;" runat="server"></asp:TextBox>
										<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox5" ErrorMessage="Message is required!" ForeColor="Red"></asp:RequiredFieldValidator>			                                
		                                <div class="help-block with-errors"></div>
		                            </div>
		                            <div class="form-group ulockd-contact-btn">		                                
										<asp:Button ID="Button1" class="btn btn-default ulockd-btn-thm2" runat="server" Text="SUBMIT" OnClick="contact_Click" />
