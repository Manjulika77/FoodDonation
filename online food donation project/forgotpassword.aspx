<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgotpassword.aspx.cs" Inherits="online_food_donation_project.forgotpassword" %>
                   ...
                   <div class="modal-dialog modal-lg" role="document">
			        				    <div class="modal-content">
			        				        <div class="modal-header">				        				        
				        				        <h3 class="modal-title text-center" id="exampleModalLabel">Forgot Password ?</h3>
				        				        <h5 class="text-center">Reset your password</h5>
			        				        </div>
			        				        <div class="modal-body">
				        				      	<div class="row">
				        				      		<div class="col-sm-12 col-md-6 col-lg-5 text-center hvr-float-shadow" style="width: 98.666667% !important;">
				        						        <div class="ulockd-login-form">
				        						        	<h2><span class="flaticon-lock"></span> Reset Password</h2>				        						        	
				        						            <div class="form-group">				            								    
																<asp:TextBox ID="TextBox1" TextMode="Email" class="form-control" placeholder="Email" runat="server"></asp:TextBox>
																<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Please Enter Registered Email!" ForeColor="Red"></asp:RequiredFieldValidator>
				            								</div>
				            								<div class="form-group">				            								    
																<asp:TextBox ID="TextBox2" TextMode="Password" class="form-control" placeholder="Old Password" runat="server"></asp:TextBox>
																<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="Please Enter Old Password!" ForeColor="Red"></asp:RequiredFieldValidator>
				            								</div>
															<div class="form-group">				            								    
																<asp:TextBox ID="TextBox3" TextMode="Password" class="form-control" placeholder="New Password" runat="server"></asp:TextBox>
																<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox3" ErrorMessage="Please Enter New Password!" ForeColor="Red"></asp:RequiredFieldValidator>
				            								</div>
															<div class="form-group">				            								    
																<asp:TextBox ID="TextBox4" TextMode="Password" class="form-control" placeholder="Confirm Password" runat="server"></asp:TextBox>
																<asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Must be match with password!" ControlToCompare="TextBox3" ControlToValidate="TextBox4" ForeColor="Red" SetFocusOnError="True" ValueToCompare="Text3.Text"></asp:CompareValidator>
				            								</div>
															<asp:Button ID="Button1" class="btn btn-default ulockd-btn-thm2" runat="server" Text="Reset Password" OnClick="reset_Click" />
															<asp:Label ID="Label1" runat="server" Text=""></asp:Label>				        						            
															<p>Click here to <a href="login.aspx" style="color: #324bf2;text-decoration: underline;font-weight:bold;">Login</a>!</p>															
				        						        </div>
				        				      		</div>				        				      		
				        				      	</div>	
			        				        </div>
