<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gallery.aspx.cs" Inherits="online_food_donation_project.galleryform" %>
            ...
            <div class="row">
	            <div class="col-md-12">
	                ...
	                <ul class="list-inline masonry-filter text-center">
	                    ...
	                    <li><a href="#" data-filter=".development" class="">Development</a></li>
	                ...
	                <div id="grid" class="masonry-gallery grid-four-item clearfix">
		                ...
		                <!-- Masonry Item -->
		                <div class="isotope-item new corporate coding">
		                    <div class="gallery-thumb">
		                ...
		                <!-- Masonry Item -->
		                <div class="isotope-item new design development">
		                    <div class="gallery-thumb">
		                ...
		                <!-- Masonry Item -->
		                <div class="isotope-item development">
		                    <div class="gallery-thumb">
