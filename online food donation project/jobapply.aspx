<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jobapply.aspx.cs" Inherits="online_food_donation_project.jobapply" %>
		...
		<div class="container text-center">
			<div class="row">
				<div class="ulockd-inner-conraimer-details">
					<div class="col-md-12">
						<h1 class="text-uppercase">JOB APPLY</h1>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-sm-12 col-md-6 col-md-offset-3">
					<div class="booking_form_style1 text-center">
		                <!-- Booking Form Sart-->
			            <div id="jobapply_form" class="booking_form_area">
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<label style="float:left;">Job Id</label>
				                    <div class="form-group">										
										<asp:TextBox ID="TextBox3" class="form-control form_control" ReadOnly="true" placeholder="Job ID" runat="server"></asp:TextBox>										
				                ...
				                <div class="col-sm-12">
				                    <div class="form-group">				                    	
										<asp:TextBox ID="TextBox2" TextMode="Email" class="form-control form_control" placeholder="youremail@yourmail.com" runat="server"></asp:TextBox>
			        			...
			        			<div class="col-md-12">
		                            <div class="form-group">											
		                                <asp:DropDownList ID="DropDownList1" class="form-control form_control" runat="server">
										<asp:ListItem Value="Data Entry Operator">Data Entry Operator</asp:ListItem>  
										<asp:ListItem Value="Fund Raiser">Fund Raiser</asp:ListItem>  
										<asp:ListItem Value="Accountant">Accountant</asp:ListItem>  
										<asp:ListItem Value="Back Office Operator">Back Office Operator</asp:ListItem>  										 
									</asp:DropDownList>	
		                                <div class="help-block with-errors"></div>
		                            </div>
				                    <div class="form-group text-left">
				                    	<label for="form_attachment"><i class="fa fa-file-text-o"></i> Upload Resume</label>					                    
					                    <asp:FileUpload ID="FileUpload1" class="form-control form_control" runat="server" />
										<div class="help-block with-errors"></div>										
				                    </div>
				                    <div class="form-group">
					                    <asp:Button ID="Button1" class="btn btn-lg btn-block ulockd-btn-thm2" runat="server" Text="Apply Now" OnClick="job_Click" />
