<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="online_food_donation_project.login" %>
                   ...
                   <div class="modal-dialog modal-lg" role="document">
			        				    <div class="modal-content">
			        				        ...
			        				        <div class="modal-body">
				        				      	<div class="row">
				        				      		<div class="col-sm-12 col-md-6 col-lg-5 text-center hvr-float-shadow" style="width: 99.666667% !important;">
				        						        <div class="ulockd-login-form">
															<br />
															<p>Yet not Registered? <a href="registerform.aspx" style="color: #324bf2;text-decoration: underline;font-weight:bold;">Sign Up</a> now! </p>
															...
															<asp:Button ID="Button1" class="btn btn-default ulockd-btn-thm2" runat="server" Text="Login to account" OnClick="login_Click" />
															<asp:Label ID="Label1" runat="server" Text=""></asp:Label>															
															<p>FORGOT PASSWORD? click here to <a href="forgotpassword.aspx" style="color: #324bf2;text-decoration: underline;font-weight:bold;">Reset Password</a></p>															
				        						        </div>
				        				      		</div>				        				      		
				        				      	</div>	
			        				        </div>
