<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="volunteersdetails.aspx.cs" Inherits="online_food_donation_project.volunteersdetails" %>
				        		...
				        		<div class="row">
				        			<div class="col-md-6">
    						            <div class="form-group">
                                            ...
                                            <asp:TextBox ID="TextBox2" class="form-control required" placeholder="First Name" runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        			<div class="col-md-6">
    						            <div class="form-group">
<%--        								    <input type="text" class="form-control required" id="exampleInputNamexx" placeholder="Last Name">--%> 
                                            <asp:TextBox ID="TextBox3" class="form-control required" placeholder="Last Name" runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        			<div class="col-md-6">
    						            <div class="form-group">
				        			...
				        			<div class="col-md-6">
    						            <div class="form-group">
                                           ...
                                           <asp:TextBox ID="TextBox6" class="form-control required" placeholder="Address line 1"  runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        			<div class="col-md-6">
    						            <div class="form-group">
        								   <%-- <input type="text" class="form-control required" id="exampleInputAddress2" placeholder="Address line 2"> --%>
                                            <asp:TextBox ID="TextBox7" class="form-control required" placeholder="Address line 2"  runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        			<div class="col-md-6">
    						            <div class="form-group">
        								    <%--<input type="text" class="form-control required" id="exampleInputCity" placeholder="City/State">--%> 
                                            <asp:TextBox ID="TextBox8" class="form-control required" placeholder="City/State" runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        			<div class="col-md-6">
    						            <div class="form-group">
        								    <%--<input type="text" class="form-control required" id="exampleInputZip" placeholder="Zipcode/Postcode"> --%>
                                            <asp:TextBox ID="TextBox9" class="form-control required" placeholder="Zipcode/Postcode"  runat="server"></asp:TextBox>
        								</div>
				        			</div>
				        		</div>
	                            <div class="form-group">
	                                <%--<textarea id="form_message" name="form_message" class="form-control required" rows="4" placeholder="Additional Note" ></textarea> --%>
                                    <asp:TextBox ID="TextBox10" class="form-control required" rows="4" placeholder="Additional Note" runat="server"></asp:TextBox>
	                            </div>
								<div class="form-group text-center">
                                    ...
                                    <asp:Button ID="Button1" class="btn btn-lg btn-block ulockd-btn-thm2" data-toggle="modal" data-target=".bs-example-modal-default" runat="server" Text="Donate now" />
								</div>
					        </form>
			      		</div>
			      	</div>
		...
		<div class="container text-center">
			<div class="row">
				<div class="ulockd-inner-conraimer-details">
					<div class="col-md-12">
						<h1 class="text-uppercase">VOLUNTEER DETAILS</h1>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-md-12">
					<div class="ulockd-icd-layer">
						<ul class="list-inline ulockd-icd-sub-menu">
							<li><a href="#"> HOME </a></li>
							<li><a href="#"> > </a></li>
							<li> <a href="#"> VOLUNTEER DETAILS </a> </li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 text-center">
					<div class="ulockd-main-title">
						...
						<h2 class="text-uppercase">OUR VOLUNTEER DETAILS</span></h2>
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="ulockd-team-member">
						...
						<div class="team-details text-left">
							...
							<img class="img-responsive img-whp" src="images/team/signeture.gif" alt="signeture.gif">
						</div>
					</div>
				</div>
				    ...
				    <div class="thumbnail">
				        <div class="caption">
							<ul class="list-unstyled ulockd-pesonar-info">
								...
								<li><strong>Profession :</strong> Tempora impedit pariatur sapiente sit distinctio.</li>
								<li><strong>Graduation :</strong> PhD in Medical Science University of Surrey 1998.</li>
								<li><strong>Experience :</strong> 18 Year Working experience in Be aHand Non-Profit Organization.</li>
								<li><strong>Address :</strong> Victoria 8007 Australia Envato HQ 121 King Street, Melbourne.</li>
			...
			<div class="row ulockd-mrgn1260">
				<div class="col-lg-4">
	            	...
	            	<ul class="list-unstyled">
	            		<li><iframe width="100%" height="195px" src="http://www.youtube.com/embed/qKoVto0Wegg?autoplay=0" allowfullscreen=""></iframe>
	            		</li>
	            	</ul>
				</div>
				<div class="col-lg-4">
					<h3>Be aHand Testimonial</h3>
		            		...
		            		<div class="media">
							 	<div class="media-left pull-left">
							  	...
							  	<div class="media-body">
							   		<h4 class="media-heading">Ana Andreea <span class="fa fa-star text-thm1"></span><span class="fa fa-star text-thm1"></span><span class="fa fa-star text-thm1"></span><span class="fa fa-star text-thm1"></span><span class="fa fa-star text-thm1"></span></h4>
							    	<p class="ulockd-tcompliment"><span class="flaticon-straight-quotes"></span> I ordinarily don't compose letters, however I felt constrained to compose this one. This is in reference to the agony administration fixate situated on the fourth floor at the Community Hospital of Be aHand, Melbourne. <span class="flaticon-blocks-with-angled-cuts"></span></p>
							  	</div>
							</div>	           			
	            		</li>
	            		<li>
		            		<div class="media">
							 	<div class="media-left pull-left">
							  	...
							  	<div class="media-body">
							   		<h4 class="media-heading">Simone Andreea <span class="fa fa-star text-thm1"></span><span class="fa fa-star text-thm1"></span><span class="fa fa-star text-thm1"></span><span class="fa fa-star text-thm1"></span><span class="fa fa-star text-thm1"></span></h4>
...
<!-- Mirrored from unlockdesizn.com/html/non-profit/be-ahand/demo/page-team-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Jun 2021 12:59:01 GMT -->
</html>